# STATUTEN VAN HET KERKGENOOTSCHAP
# TECHNO CHURCH RELIGION
...
1. Het lidmaatschap eindigt door:
   ...
   a. Schriftelijke opzegging door het lid, met inachtneming van een opzegtermijn van één maand;
...
3. Bij vacature kan het bestuur in de tussentijd een opvolger aanwijzen tot de eerstvolgende algemene vergadering.

**Artikel 9 — Taken en bevoegdheden**

1. Het bestuur is belast met het besturen van de Kerk, het beheren van het vermogen, en het vertegenwoordigen van de Kerk in en buiten rechte.
...
1. Het bestuur vergadert zo vaak als de voorzitter of twee bestuursleden dit nodig achten, doch minimaal vier maal per jaar.

2. Besluiten worden genomen bij gewone meerderheid van stemmen. Bij staking van stemmen beslist de voorzitter.

**Artikel 10a — Bezoldiging van bestuurders**

1. Bestuursleden kunnen een vergoeding ontvangen voor hun werkzaamheden ten behoeve van de Kerk. De hoogte van de vergoeding is proportioneel aan de omvang van de werkzaamheden en de beschikbare middelen van de Kerk.

2. De bezoldiging wordt jaarlijks vastgesteld door de algemene vergadering op voorstel van het bestuur, met inachtneming van de volgende bandbreedtes:

   | Functie | Ceremoniële Titel | Aard | Bandbreedte (bruto/maand) |
   |---|---|---|---|
   | Voorzitter | The Prime Mover | Deeltijd (ca. 16 uur/week) | € 800 – € 2.000 |
...
1. Jaarlijks, uiterlijk zes maanden na afloop van het boekjaar, wordt een algemene vergadering gehouden.

2. De algemene vergadering wordt bijeengeroepen door het bestuur met een oproeptermijn van minimaal veertien dagen, via schriftelijke of digitale kennisgeving aan de leden.

3. De algemene vergadering besluit over:

   a. Vaststelling van de jaarrekening;

   b. Benoeming en ontslag van bestuursleden;

   c. Wijziging van de statuten;

   d. Ontbinding van de Kerk;

   e. Overige door het bestuur voorgelegde onderwerpen.

4. Elk stemgerechtigd lid heeft één stem. Stemming geschiedt bij handopsteking of schriftelijk. Volmachtverlening is toegestaan aan een ander lid.
...
1. Het boekjaar van de Kerk loopt van 1 januari tot en met 31 december.

2. Het bestuur is verantwoordelijk voor het bijhouden van een deugdelijke administratie en het beheer van de financiële middelen van de Kerk.
...
1. Wijziging van deze statuten is mogelijk bij besluit van de algemene vergadering, genomen met een meerderheid van ten minste twee derde van de uitgebrachte stemmen.

2. Het voorstel tot wijziging dient ten minste veertien dagen voor de vergadering aan de leden kenbaar te zijn gemaakt.
...
1. De Kerk kan worden ontbonden bij besluit van de algemene vergadering, genomen met een meerderheid van ten minste drie kwart van de uitgebrachte stemmen in een vergadering waarvoor ten minste de helft van de stemgerechtigde leden aanwezig of vertegenwoordigd is.

2. Bij ontbinding wordt het batig saldo na vereffening bestemd voor een door de algemene vergadering aan te wijzen organisatie met een gelijksoortige religieuze of culturele doelstelling.
...
2. Op alle geschillen die voortvloeien uit of verband houden met deze statuten is Nederlands recht van toepassing.

---

*Aldus vastgesteld door de oprichters op _____________ te Amsterdam.*

| Functie | Naam | Handtekening |
|---|---|---|
| Voorzitter (The Prime Mover) | __________________ | __________________ |
| Secretaris | __________________ | __________________ |
| Penningmeester | __________________ | __________________ |

---

*Techno Church Religion — "In Beat We Trust"*
